...
router.post('/register', (request, response, next) => {
    ...
    return auth.signUp({ ...request.body }).then(({data, message}) => {
        return response.json({
            success: true,
            data: data,
            message: message
...
router.post('/login', (request, response, next) => {
    ...
    return auth.login({ ...request.body }).then(({data, message}) => {
        return response.json({
            success: true,
            data: data,
            message: message
...
router.post('/google', (request, response, next) => {
    ...
    return auth.googleLogin({ ...request.body }).then(({data, message}) => {
        return response.json({
            success: true,
            data: data,
            message: message
...
router.post('/apple', (request, response, next) => {
    ...
    return auth.appleLogin({ ...request.body }).then(({data, message}) => {
        return response.json({
            success: true,
            data: data,
            message: message
...
router.get('/logout', authMiddleware, (request, response, next) => {
    ...
    return auth.logout({ session_id }).then(({data, message}) => {
        return response.json({
            success: true,
            data: data,
            message: message
...
router.get('/update-password', authMiddleware, (request, response, next) => {
    ...
    return auth.updatePassword({ current_password, new_password, user_id }).then(({data, message}) => {
        return response.json({
            success: true,
            data: data,
            message: message
