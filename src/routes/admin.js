...
router.post('/register', (request, response, next) => {
    ...
    return admin.createAdmin({ ...request.body }).then(({data, message}) => {
        return response.json({
            success: true,
            data: data,
            message: message
...
router.post('/login', (request, response, next) => {
    ...
    return admin.login({ ...request.body }).then(({data, message}) => {
        return response.json({
            success: true,
            data: data,
            message: message
...
router.post('/users-list', authAdminMiddleware, (request, response, next) => {
    return admin.getUsers({ ...request.body }).then(({data, message}) => {
        return response.json({
            success: true,
            data: data,
            message: message
